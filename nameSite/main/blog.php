...
?>
 ...
 <!-- static Carousel
    ...
    class="img-circle" title="Slow Life Inn, Pai, Thailand"></a></p>
              <p style="font-size:40px">steven<b>blogs</b></p>
            </div>
          </div>
        </div>
    </div><!-- /.carousel -->
 ...
 <!-- START THE FEATURETTES -->
  <div class="container marketing">
      ...
      <div class="row featurette">
		...
		<a href="http://www.humanconnectomeproject.org/" target="_blank">The Human Connectome Project</a>, <a href="http://www.thinkwithgoogle.com/articles/transgressive-man.html" target="_blank">Google with Ray Kurzweil</a>, and <a href="http://www.rni.org/directors.html" target="_blank">Jeff Hawkins</a> to name a few. <br/>
	...
	<a href="http://www.listentobitcoin.com" target="_blank">ListenToBitcoin.com</a></p>
        </div>
        <div class="col-md-5">
          <img class="featurette-image img-responsive"
